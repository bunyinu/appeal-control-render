    ...
    return (
      <>
        ...
        <p>
          ...
          website{' '}
          {projectUrl ? <a href={projectUrl}>{projectUrl}</a> : 'this site'},
  ...
  const ContactUs = () => {
    return (
      <>
        <h3>10. Contact Us</h3>
        <p>
          If you have any questions about this Privacy Policy, contact your
          organization administrator or the team responsible for this
          deployment.
        </p>
      </>
    );
