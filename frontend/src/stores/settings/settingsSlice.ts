...
export const deleteItem = createAsyncThunk('settings/deleteSettings', async (id: string, { rejectWithValue }) => {
    try {
...
export const create = createAsyncThunk('settings/createSettings', async (data: any, { rejectWithValue }) => {
    try {
...
export const update = createAsyncThunk('settings/updateSettings', async (payload: any, { rejectWithValue }) => {
    try {
